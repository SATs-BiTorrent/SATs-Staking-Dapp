...
export const StakeToken = () => {
    ...
    const { data: stakingTokenBalance, isLoading: loadingStakeTokenBalance, refetch: refetchStakingTokenBalance } = useReadContract(
        balanceOf,
        {
            ...
            address: account?.address || "getStakeInfo",
            queryOptions: {
                enabled: !!account,
            }
        }
                ...
                <div style={{
                    ...
                    {stakeInfo && (
                        <>
                            ...
                            <div>
                                <p style={{ color: "white" }}>Balance Staked: {truncate(toEther(stakeInfo[0]).toString(),2)}</p>
                                <p style={{ color: "white" }}>Reward SATs Balance: {truncate(toEther(stakeInfo[1]).toString(),2)}</p>
                                <TransactionButton
                                    transaction={() => (
                                        prepareContractCall({
                                            contract: STAKING_CONTRACT,
                                ...
                                >Claim SATs (BitTorrent)</TransactionButton>
                            </div>
                        </>
                    )}
                    {isStaking && (
                        <div style={{
                            ...
                            <div style={{
                                ...
                                >Close</button>
                                <h3 style={{ color: "white" }}>Stake WBTTC</h3>
                                <p style={{ color: "white" }}>Balance: {toEther(stakingTokenBalance!)}</p>
                                {stakingState === "init" ? (
                                    <>
                                        <input 
                                            type="number" 
                                    ...
                                    <>
                                        <h3 style={{ margin: "10px 0", color: "white" }}>{stakeAmount}</h3>
                                        <TransactionButton
                                            transaction={() => (
                                                prepareContractCall({
                                                    contract: STAKING_CONTRACT,
                    ...
                    {isWithdrawing && (
                        <div style={{
                            ...
                            <div style={{
                                ...
                                >Close</button>
                                <h3 style={{ color: "white" }}>Withdraw WBTTC</h3>
                                <input 
                                    type="number" 
                                    placeholder="0.0"
                                ...
                                >Withdraw WBTTC</TransactionButton>
                            </div>
                        </div>
                    )}
                </div>
